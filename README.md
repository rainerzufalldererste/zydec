...
(i64)r9_Loc_XaKe = &(data_segment: (i64)r8_Loc_Vadu + ((i64)d_Pop_jeTo * 2));
...
(m256)y13_bor_goFi = _mm_or_si((m256)y1_Shl_Feqi, (m256)y2_Cov_soma);
...
(i32)d_Pop_Feze = (i32)d_Pop_Feze;

// 1400002B0: lea r8, ds:[r9+rdx*2]                             
(i64)r8_Loc_Jai_ = &(data_segment: (i64)r9_Loc_XaKe + ((i64)d_Pop_Feze * 2));
...
(i64)a_Loc_Na4o = &(data_segment: (i64)r8_Loc_Jai_ + ((i64)d_Pop_yogo * 2));
...
(m256)y14_bor_v_qa = _mm_or_si((m256)y1_Shl_jaWu, (m256)y2_Cov_qe7o);
...
(m256)y11_bor_bui_ = _mm_or_si((m256)y1_Shl_Cupa, (m256)y2_Cov_pex_);
...
(m256)y12_bor_7ito = _mm_or_si((m256)y1_Shl_loQa, (m256)y2_Cov_tipa);
...
_mm_unaligned_store_si((stack_segment: (i64)bp_And_quHu), (m256)y13_bor_goFi);

// 14000034D: vmovdqu ymmword ptr ss:[rbp+0x20], ymm14          
_mm_unaligned_store_si((stack_segment: (i64)bp_And_quHu + 32), (m256)y14_bor_v_qa);

// 140000352: vmovdqu ymmword ptr ss:[rbp+0x40], ymm11          
_mm_unaligned_store_si((stack_segment: (i64)bp_And_quHu + 64), (m256)y11_bor_bui_);

// 140000357: vmovdqu ymmword ptr ss:[rbp+0x60], ymm12          
_mm_unaligned_store_si((stack_segment: (i64)bp_And_quHu + 96), (m256)y12_bor_7ito);
