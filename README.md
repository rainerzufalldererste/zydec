...
14000028F | (m256)y2 = _mm_cvtepu16_epi32((m128)x1);                                                        | vpmovzxwd ymm2, xmm1
...
1400002A4 | _mm_unaligned_load_si((m128)x4, (data_segment: (i64)r9));                                       | vmovdqu xmm4, xmmword ptr ds:[r9]
...
1400002C7 | _mm_unaligned_load_si((m128)x5, (data_segment: (i64)r8));                                       | vmovdqu xmm5, xmmword ptr ds:[r8]
1400002CC | (m256)y2 = _mm_cvtepu16_epi32((m128)x3);                                                        | vpmovzxwd ymm2, xmm3
1400002D1 | _mm_unaligned_load_si((m256)y3, (data_segment: 0x14028D228));                                   | vmovdqu ymm3, ymmword ptr ds:[0x000000014028D230]
...
1400002FA | _mm_unaligned_load_si((m256)y15, (data_segment: 0x14028D348));                                  | vmovdqu ymm15, ymmword ptr ds:[0x000000014028D350]
...
140000310 | (m256)y2 = _mm_cvtepu16_epi32((m128)x4);                                                        | vpmovzxwd ymm2, xmm4
140000315 | (m256)y11 = _mm_or_si((m256)y1, (m256)y2);                                                      | vpor ymm11, ymm1, ymm2
140000319 | _mm_unaligned_load_si((m256)y1, (stack_segment: (i64)bp + 128));                                | vmovdqu ymm1, ymmword ptr ss:[rbp+0x80]
140000321 | (m256)y2 = _mm_cvtepu16_epi32((m128)x5);                                                        | vpmovzxwd ymm2, xmm5
140000326 | (m256)y1 = _mm_sllv_epi32((m256)y1, (m256)y0);                                                  | vpsllvd ymm1, ymm1, ymm0
14000032B | _mm_unaligned_load_si((m256)y0, (data_segment: 0x14028D308));                                   | vmovdqu ymm0, ymmword ptr ds:[0x000000014028D310]
140000333 | (m256)y12 = _mm_or_si((m256)y1, (m256)y2);                                                      | vpor ymm12, ymm1, ymm2
140000337 | _mm_unaligned_load_si((m256)y2, (data_segment: 0x14028D248));                                   | vmovdqu ymm2, ymmword ptr ds:[0x000000014028D250]
...
140000370 | _mm_unaligned_load_si((m256)y0, (data_segment: (i64)r8 + (i64)c));                              | vmovdqu ymm0, ymmword ptr ds:[r8+rcx*1]
...
14000037E | (i64)d -= 1;                                                                                    | sub rdx, 0x01
140000382 | if (!zero_flag) goto 0x14000036E; // if not zero / not equal                                    | jnz 0x0000000140000370
140000384 | (i64)a = (i64)di;                                                                               | mov rax, rdi
```
